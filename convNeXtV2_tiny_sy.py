...
def main():
    ...
    BATCH_SIZE = 32
    EPOCHS = 50
    SAVE_NAME = "convNeXtTiny_V2_randomCrop"
    IMG_PATH = "data/t_shirt.jpg"       # 이미지 1개 or 이미지 리스트["data/t_shirt.jpg", "data/sweater_test.jpg"] 상관없음

    ###############
    # 데이터 가져오기
    ###############
    # transforms_train, transforms_test = baseline_training()
    transforms_train, transforms_test = get_transforms(augmentations=["random_crop"])
